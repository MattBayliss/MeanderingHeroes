...
namespace MeanderingHeroes.Engine.Types
{
    public static class CurveLibrary
    {
        ...
        public static CurveDefinition NotUrgentUntilItIs => new("NotUrgentUntilItIs", CurveType.Logistic, 1f, 1.1f, -0.05f, 0.5f);
        public static CurveDefinition IsZero => new("IsZero", CurveType.MatchValue, 1f, 0f, 0f, 0f);
        public static CurveDefinition IsNotZero => new("IsNotZero", CurveType.MatchValue, 0f, 1f, 0f, 0f);
    }
}
